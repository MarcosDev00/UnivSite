...
require_once ('connect.php');
	if (isset($_POST) & !empty($_POST)) {
		...
		if ($res) {
			...
			$erreur = "Erreur d'insertion à la base";
		}
	}
		...
		<div class="row pt-4">
			...
			<form action="" method="POST" class="form-horizontal col-md-6 pt-4">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" name="Prénom" placeholder="Prénom" class="form-control" id="input1">
					</div>
				</div>
				...
				<div class="form-group">
					<label for="input1" class="col-sm-2 control-label">Âge</label>
					<div class="col-sm-10">
						<select name="age" class="form-control">
							<option>Indiquer l'âge</option>
